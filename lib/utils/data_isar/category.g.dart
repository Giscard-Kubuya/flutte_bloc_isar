...
void _categorySerialize(
  ...
  writer.writeDateTime(offsets[0], object.createdAtCat);
...
Category _categoryDeserialize(
  ...
  object.createdAtCat = reader.readDateTimeOrNull(offsets[0]);
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> createdAtCatIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'createdAtCat',
      ));
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      createdAtCatIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> createdAtCatEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> createdAtCatLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> createdAtCatBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  QueryBuilder<Category, Category, QAfterSortBy> sortByCreatedAtCat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtCat', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByCreatedAtCatDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtCat', Sort.desc);
    });
  }
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByCreatedAtCat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtCat', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByCreatedAtCatDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtCat', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByCreatedAtCat() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdAtCat');
    });
  }
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, DateTime?, QQueryOperations> createdAtCatProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAtCat');
    });
  }
